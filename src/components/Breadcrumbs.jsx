...
const Breadcrumbs = ({ items, separator, onTitleChange }) => {
	...
	const handleKeyDown = (e) => {
		if (e.key === 'Enter') {
			setIsEditing(false)
			onTitleChange(editableLabel) // Trigger parent update
		}
	}
						...
						isEditing ? (
							...
							<div className="flex items-center space-x-1">
								<span
									...
									className="text-gray-800 font-semibold hover:underline cursor-pointer text-base truncate max-w-40"
									title={editableLabel}
								>
									{editableLabel}
								</span>
...
Breadcrumbs.propTypes = {
	...
	onTitleChange: PropTypes.func.isRequired, // New prop validation
}
